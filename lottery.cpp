...
bool Lottery::FromFile(const QString& txt, int year, int week, bool* isExist){
    ...
    *isExist = false;
    ...
    static const int hit6_ix = 3;
    static const int hit5_ix = 5;
    static const int hit4_ix = 7;
    static const int hit3_ix = 9;
    static const int hit2_ix = 11;
    static const int hit_len = 2;
    static const int numbers_ix = 13;
...
Lottery::RefreshR Lottery::Refresh(int year, int week){
    ...
    static Lottery::RefreshR nullobj{false, {0}, {{0},{0},{0},{0},{0},{0}},  0, 0};
...
QVector<qreal> Lottery::LastOccurences(const QVector<Data>& data){
    int L = Lottery::Settings::TOTAL_NUMBERS;
